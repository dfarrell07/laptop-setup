...
printf "%s\n\n" "═══════════════════════════════════════════════"
printf "Next steps:\n\n"
printf "  1. Set a strong FIDO2 PIN and enforce a minimum length:\n"
printf "       ykman fido access change-pin         # set initial PIN\n"
printf "       ykman fido access set-min-length 12  # enforce 12-char minimum\n"
printf "                                            # (ratchet: cannot shorten without full FIDO reset)\n"
printf "       ykman fido access force-change        # invalidate any PIN shorter than the new minimum\n\n"
